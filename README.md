...
To set up the backend for the project properly, you should navigate to the backend folder and run: $npm install  
After this, just run $node server.js, and the backend server should now be running
